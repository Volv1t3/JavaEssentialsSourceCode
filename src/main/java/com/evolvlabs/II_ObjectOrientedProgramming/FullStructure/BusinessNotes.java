...
public class BusinessNotes implements ListableNotes, Comparable<BusinessNotes> {

    //! Miembros
    private String businessName;
    private List<BusinessNote> internalNoteHolder = new ArrayList<>();



    //! Constructor
    public BusinessNotes(String businessName) {
    ...
    @Override
    public void sort() {
        this.internalNoteHolder.sort(Comparator.naturalOrder());
    }
    ...
    public void organizarPorCriterio(Comparator<Notes> criterio) {
        this.internalNoteHolder.sort(criterio);
    }

    public void organizarUsandoPersonalNote(Comparator<BusinessNote> criterio){
     ...
     */
    @Override
    public void appendToList(Notes nota) {
        if (nota != null){
            if (nota instanceof BusinessNote) {
                if (!this.internalNoteHolder.contains(nota)){
                    ((BusinessNote) nota).setBusinessName(this.businessName);
                    this.internalNoteHolder.add((BusinessNote) nota);
                }
                else {
                ...
                throw new InvalidNotesListState("La nota seleccionada no es del tipo BusinessNote");
            }
        }else {
    ...
    public boolean equals(Object obj) {
        if (obj == null || obj.getClass() != this.getClass()){
            ...
            try{
                BusinessNotes other = (BusinessNotes) obj;
    ...
    public String toString() {
        StringBuilder objectPersonalToString = new StringBuilder(   this.businessName + "-BusinessNotes{ " +
                "internalNoteHolder= ");
     ...
     */
    @Override
    public int compareTo(BusinessNotes o) {
        if (o.getList() == null){
