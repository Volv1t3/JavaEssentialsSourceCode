 ...
 * entorno de trabajo.</body>
 */
public class PersonalMeeting extends Meeting{


    /*! Parametros de la clase implementadora*/
    private String i_MeetingAsigne;

    /*! Constructores */
    public PersonalMeeting(Integer e_MeetingID, String e_MeetingTitle,
    ...
    /*! Setters y Getters*/
    public void setI_MeetingAsigne(String i_MeetingAsigne) throws InvalidMeetingParameter{
