...
public class InvalidTaskParameter extends InvalidParameterException {
     ...
     */
    public InvalidTaskParameter(String msg) {
        super(msg);
        this.prettyMessage = "Error InvalidTaskParameter extends InvalidParameterException Thrown: " + msg;
    }
     ...
     */
    public InvalidTaskParameter() {
        super();
        this.prettyMessage = "Error InvalidTaskParameter extends InvalidParameterException Thrown";
    }
     ...
     * @since 20
     */
    public InvalidTaskParameter(String msg, Throwable cause) {
        super(msg, cause);
        this.prettyMessage = "Error InvalidTaskParameter extends InvalidParameterException Thrown: " + msg +" a causa de" +
     ...
     * @since 20
     */
    public InvalidTaskParameter(Throwable cause) {
        super(cause);
    }
